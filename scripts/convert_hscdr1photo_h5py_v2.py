...
for hscfile in hscfiles:
    ...
    #print('loaded data')
    #Joining the tables
    hsc_shearall = getdata(hscfile)#vstack(tables)
    ...
    gflux_cut = (hsc_shearall['icmodel_flux']/hsc_shearall['gcmodel_flux_err']>=5)
    ...
    redshift_true = hsc_shearall['pz_mean_eab']
    ...
    data   = [dec, g_mag, g_mag_err, i_mag, i_mag_err, objectId, r_mag, r_mag_err, ra, snr_g, snr_i, snr_r, u_mag, u_mag_err, snr_u, y_mag, y_mag_err, snr_y, z_mag, z_mag_err, snr_z, mean_z, sigma_e, redshift_true,extendedness]

    dnames = ['dec', 'mag_g', 'mag_g_err', 'mag_i', 'mag_i_err', 'objectId', 'mag_r', 'mag_r_err', 'ra', 'snr_g', 'snr_i', 'snr_r', 'mag_u', 'mag_u_err', 'snr_u', 'mag_y', 'mag_y_err', 'snr_y', 'mag_z', 'mag_z_err', 'snr_z', 'mean_z', 'sigma_e','redshift_true','extendedness']
